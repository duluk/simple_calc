...
long
simple_evaluate(char * expression)
{
    char * p = NULL;
...
void
assert_calc_func(const char * expr, long expected, long (*func)(char *))
{
    long r = 0l;
